...
if user_menu == 'Overall Analysis':
    ...
    st.plotly_chart(fig, key="events_over_time")
    ...
    st.plotly_chart(fig, key="athletes_over_time")
    ...
    fig = px.line(
        ...
        x="Year",
        y="count",
        title="Number of Sports Over Time"
    )
    st.plotly_chart(fig, key="sports_over_time")
